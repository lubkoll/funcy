...
namespace funcy
{
    namespace Concepts
    {
        ...
        /// Requires that multiplication with double and int can be performed either by in-place
        /// multiplication or by multiplication from the left.
         ...
         *
         * Requires that either a free operator*(Arg1,Arg2) exists for multiplication or Arg1
         * provides either the in-place multiplication operator*=(Arg2) or the member function
        ...
        struct MultiplicationConcept
        {
            ...
            /// Multiplication via rightmultiplyany(Arg2). Return type is not checked to support
            /// lazy evaluation.
         ...
         *
         * Multiplication between different matrices is not checked here, since this would require
         * to provide all possible matrices to multiply a matrix of type Arg with.
         */
        struct ArithmeticConcept : CopyConcept,
         ...
         *
         * Access to matrix elements must be possible either via A[i][j] or A(i,j). Moreover the
         * requirements of ArithmeticConcept must be satisfied.
         */
         ...
         *
         * Access to vector elements must be possible either via A[i] or A(i). Moreover the
         * requirements of ArithmeticConcept must be satisfied.
         */
         ...
         *
         * The requirements of MatrixConcept must be satisfied and the number of rows and columns
         * must be equal.
         */
