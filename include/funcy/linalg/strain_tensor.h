...
namespace funcy
{
    ...
    namespace linalg
    {
        ...
        class RightCauchyGreenStrainTensor :
                public Chainer< RightCauchyGreenStrainTensor<Matrix , Concepts::SquareIsMatrix<Matrix> > >
        {
        public:
        ...
        class LeftCauchyGreenStrainTensor :
                public Chainer< LeftCauchyGreenStrainTensor<Matrix , Concepts::SquareIsMatrix<Matrix> > >
        {
        public:
        ...
        /**
         * \brief Generate the right Cauchy-Green strain tensor \f$f*f^T\f$, where \f$f:\cdot\mapsto\mathbb{R}^{n,n} \f$.
        ...
        /**
         * \brief Generate the left Cauchy-Green strain tensor \f$f^T*f\f$, where \f$f:\cdot\mapsto\mathbb{R}^{n,n} \f$.
         * \param f function object mapping into a space of square matrices
