...
namespace funcy
{
  namespace linalg
  {
    ...
    struct ConstantSizeTrace : Chainer< ConstantSizeTrace< Matrix , Concepts::SquareIsMatrix<Matrix> > >
    {
    ...
    template< class Matrix >
    using Trace = std::conditional_t< Concepts::isConstantSize<Matrix>() , ConstantSizeTrace<Matrix> , DynamicSizeTrace<Matrix> >;
