...
{
  /// @cond
  namespace Concepts {  template <class> struct SquareIsMatrix; }
  /// @endcond
  ...
  namespace linalg
  {
    ...
    namespace Detail
    {
      ...
      template <class Matrix, int dim, class = Concepts::SquareIsMatrix<Matrix> >
      class DeterminantImpl;

      template<class Matrix>
      class DeterminantImpl< Matrix , 2 , Concepts::SquareIsMatrix<Matrix> >
          : public Chainer< DeterminantImpl<Matrix,2,Concepts::SquareIsMatrix<Matrix> > >
      {
      public:
      ...
      template <class Matrix>
      class DeterminantImpl<Matrix,3,Concepts::SquareIsMatrix<Matrix> >
          : public Chainer< DeterminantImpl<Matrix,3,Concepts::SquareIsMatrix<Matrix> > >
      {
      public:
        DeterminantImpl() = default;
    ...
    template < class Matrix >
    using Determinant = std::conditional_t< Concepts::isConstantSize<Matrix>() , ConstantSizeDeterminant<Matrix> , DynamicSizeDeterminant<Matrix> >;
    /// @endcond
