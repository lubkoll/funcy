...
namespace funcy
{
    ...
    {
        return mathop::Min< std::decay_t< F >, std::decay_t< G > >( std::forward< F >( f ),
                                                                    std::forward< G >( g ) );
    }
    ...
    {
        return mathop::Min< std::decay_t< F >, Constant< std::decay_t< G > > >(
    ...
    {
        return mathop::Min< Constant< std::decay_t< F > >, std::decay_t< G > >(
