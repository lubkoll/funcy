...
namespace funcy
{
    ...
    namespace mathop
    {
        /*!
          ...
          function as building block for more complex functions requires directional derivatives.
          These occur during applications of the chain rule.
         */
    ...
    {
        return mathop::Max< std::decay_t< F >, std::decay_t< G > >( std::forward< F >( f ),
                                                                    std::forward< G >( g ) );
    }
    ...
    {
        return mathop::Max< std::decay_t< F >, Constant< std::decay_t< G > > >(
    ...
    {
        return mathop::Max< Constant< std::decay_t< F > >, std::decay_t< G > >(
