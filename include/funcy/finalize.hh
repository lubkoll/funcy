...
namespace funcy
{
    ...
    namespace Detail
    {
        ...
        struct FinalizeImpl : F
        {
            ...
            ReturnType d3( const ArgX& dx, const ArgY& dy, const ArgZ& dz ) const
            {
                ...
                static_assert( concept::checkArgument< F, ArgY, idy >(),
                               "Incompatible second argument in computation of third derivative." );
                static_assert( concept::checkArgument< F, ArgZ, idz >(),
                               "Incompatible third argument in computation of third derivative." );
                static_assert( concept::Has::consistentThirdDerivative< F, IndexedType< ArgX, idx >,
                                                                       IndexedType< ArgY, idy >,
                ...
                return FinalizeD3<
                    ...
                    concept::Has::MemFn::d3< F, IndexedType< ArgX, idx >, IndexedType< ArgY, idy >,
        ...
        struct FinalizeImpl< F, false > : F
        {
            ...
            ReturnType d1( const Arg& dx ) const
            {
                ...
                return FinalizeD1< 0, ReturnType,
                                   concept::Has::MemFn::d1< F, IndexedType< Arg, 0 > >::value >()(
                    static_cast< const F& >( *this ), dx );
            }
            ...
            ReturnType d2( const ArgX& dx, const ArgY& dy ) const
            {
                static_assert( concept::Has::consistentSecondDerivative< F, IndexedType< ArgX, 0 >,
                                                                        IndexedType< ArgY, 0 > >(),
                               "Inconsistent functional definition encountered." );
                return FinalizeD2< 0, 0, ReturnType,
                                   concept::Has::MemFn::d2< F, IndexedType< ArgX, 0 >,
            ...
            ReturnType d3( const ArgX& dx, const ArgY& dy, const ArgZ& dz ) const
            {
                static_assert( concept::Has::consistentThirdDerivative< F, IndexedType< ArgX, 0 >,
                                                                       IndexedType< ArgY, 0 >,
                                                                       IndexedType< ArgZ, 0 > >(),
                               "Inconsistent functional definition encountered." );
                return FinalizeD3<
                    0, 0, 0, ReturnType,
                    concept::Has::MemFn::d3< F, IndexedType< ArgX, 0 >, IndexedType< ArgY, 0 >,
    ...
    auto finalize( F&& f )
    {
        return Detail::FinalizeImpl< std::decay_t< F >,
                                     concept::Has::variable< std::decay_t< F > >() >(
            std::forward< F >( f ) );
    }
}
